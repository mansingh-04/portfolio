...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Python', 'Flask', 'HTML', 'CSS', 'JavaScript','Vercel(for deployment)'],
      hostedUrl: 'https://api-coral-six-85.vercel.app/'
    },
    {
      ...
      technologies: ['React', 'HTML', 'CSS', 'JavaScript','Vercel(for deployment)'],
      hostedUrl: 'https://discord-clone-theta-neon.vercel.app/'
    }
  ];
